...
class _AdminScreenState extends State<AdminScreen> {
  ...
  Future<void> _rejectEvent(Event event, String reason) async {
    ...
    try {
      ...
      print('Rejected event: ${event.id}, title: ${event.title}, reason: $reason');
      Fluttertoast.showToast(
        msg: "Event Rejected!",
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.CENTER,
              ...
              : SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: events.map((event) {
                      final isVerified = event.isVerified || event.verificationStatus == 'approved';
                        ...
                        DataCell(
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isVerified
                                  ? Colors.green
                                  : (event.verificationStatus == 'pending' ? Colors.orange : Colors.red),
                              borderRadius: BorderRadius.circular(12),
                            ),
                            child: Text(
                              isVerified
                                  ? 'Verified'
                                  : (event.verificationStatus == 'pending' ? 'Pending' : 'Unverified'),
                          ...
                          event.verificationDocumentUrl != null &&
                              ...
                              ? InkWell(
                                  onTap: () {
                                    ...
                                    print('Opening document: ${event.verificationDocumentUrl}');
                                    Fluttertoast.showToast(
                                      msg: "Document URL: ${event.verificationDocumentUrl}",
                                      toastLength: Toast.LENGTH_LONG,
                                      gravity: ToastGravity.CENTER,
                                    );
                                  },
                                      ...
                                      actions: [
                                        ...
                                        ElevatedButton(
                                          onPressed: () {
                                            ...
                                            _rejectEvent(event, controller.text.trim());
                                          },
